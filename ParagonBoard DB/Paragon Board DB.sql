...
VALUES('park','1234','박종일','19901007','인천남동구','010-1111-2222',20);
INSERT INTO MEMBER(M_ID,M_PWD,M_NAME,M_BIRTH,M_ADDR,M_PHONE,M_POINT)
VALUES('test','1234','손님','19901231','서울 강남','010-2222-3333',DEFAULT);
...
g_contents text binary not null,
m_id varchar(20) binary not null,
g_date datetime default current_timestamp
);

insert into guestbook
value(default,'방명록1 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록2 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록3 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록4 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록5 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록6 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록7 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록8 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록9 내용입니다.','jek',default);
insert into guestbook
value(default,'방명록10 내용입니다.','jek',default);
...
-- 최신글순으로 원글 출력 VIEW
CREATE OR REPLACE VIEW GLIST AS
SELECT G.G_NUM,
       G.G_CONTENTS,
       G.M_ID,
       G.G_DATE
FROM GUESTBOOK G INNER JOIN MEMBER M
ON G.M_ID=M.M_ID
